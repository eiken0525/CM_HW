...
\begin{problem}
    ...
    \end{enumerate}
\end{problem}
\textbf{Solution}. By Taylor's theorem, the second Taylor polynomial about $0$ is \vspace{-0.6em}
\begin{align*}
    P_2(x)&=f(0)+\dfrac{1}{1!}\cdot\dfrac{\dd f}{\dd x}(0)\cdot x+\dfrac{1}{2!}\cdot\dfrac{\dd^2 f}{\dd x^2}(0)\cdot x^2\\
    &=1+x.
\end{align*}
